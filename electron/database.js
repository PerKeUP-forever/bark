...
function seedPresetQuotaItems(force = false) {
  ...
  const presets = [
    ...
    // ===== 材料费 - 暖通管道 =====
    { category: 'material', name: 'PVC给水管', spec: 'DN20', unit: 'm', unit_price: 4, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN25', unit: 'm', unit_price: 5.5, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN32', unit: 'm', unit_price: 7, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN40', unit: 'm', unit_price: 9, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN50', unit: 'm', unit_price: 12, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN63', unit: 'm', unit_price: 16, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN75', unit: 'm', unit_price: 20, work_hours: 0, remark: '' },
    { category: 'material', name: 'PVC给水管', spec: 'DN110', unit: 'm', unit_price: 32, work_hours: 0, remark: '' },
    { category: 'material', name: 'PPR-PVC复合保温管', spec: 'DN20', unit: 'm', unit_price: 18, work_hours: 0, remark: '自带保温层' },
    { category: 'material', name: 'PPR-PVC复合保温管', spec: 'DN25', unit: 'm', unit_price: 24, work_hours: 0, remark: '自带保温层' },
    { category: 'material', name: 'PPR-PVC复合保温管', spec: 'DN32', unit: 'm', unit_price: 32, work_hours: 0, remark: '自带保温层' },
    { category: 'material', name: 'PPR-PVC复合保温管', spec: 'DN40', unit: 'm', unit_price: 42, work_hours: 0, remark: '自带保温层' },
    { category: 'material', name: 'PPR-PVC复合保温管', spec: 'DN50', unit: 'm', unit_price: 55, work_hours: 0, remark: '自带保温层' },
    { category: 'material', name: 'PPR-PVC复合保温管', spec: 'DN63', unit: 'm', unit_price: 72, work_hours: 0, remark: '自带保温层' },
    { category: 'material', name: '不锈钢管', spec: 'DN15 304', unit: 'm', unit_price: 28, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN20 304', unit: 'm', unit_price: 35, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN25 304', unit: 'm', unit_price: 45, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN32 304', unit: 'm', unit_price: 58, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN40 304', unit: 'm', unit_price: 72, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN50 304', unit: 'm', unit_price: 90, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN65 304', unit: 'm', unit_price: 115, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN80 304', unit: 'm', unit_price: 145, work_hours: 0, remark: '薄壁不锈钢' },
    { category: 'material', name: '不锈钢管', spec: 'DN100 304', unit: 'm', unit_price: 195, work_hours: 0, remark: '薄壁不锈钢' },
    ...
    // ----- 暖通设备 -----
    { category: 'equipment', name: '空气源热泵机组', spec: '10P 制热量28kW', unit: '台', unit_price: 32000, work_hours: 0, remark: '含室外机' },
    { category: 'equipment', name: '空气源热泵机组', spec: '15P 制热量42kW', unit: '台', unit_price: 45000, work_hours: 0, remark: '含室外机' },
    { category: 'equipment', name: '空气源热泵机组', spec: '20P 制热量56kW', unit: '台', unit_price: 58000, work_hours: 0, remark: '含室外机' },
    { category: 'equipment', name: '空气源热泵机组', spec: '25P 制热量70kW', unit: '台', unit_price: 72000, work_hours: 0, remark: '含室外机' },
    { category: 'equipment', name: '空气源热泵机组', spec: '30P 制热量84kW', unit: '台', unit_price: 85000, work_hours: 0, remark: '含室外机' },
    { category: 'equipment', name: '循环水泵', spec: 'Q=5m³/h H=20m 1.5kW', unit: '台', unit_price: 2200, work_hours: 0, remark: '暖通循环' },
    { category: 'equipment', name: '循环水泵', spec: 'Q=10m³/h H=25m 3kW', unit: '台', unit_price: 3800, work_hours: 0, remark: '暖通循环' },
    { category: 'equipment', name: '循环水泵', spec: 'Q=20m³/h H=30m 5.5kW', unit: '台', unit_price: 5500, work_hours: 0, remark: '暖通循环' },
    { category: 'equipment', name: '循环水泵', spec: 'Q=30m³/h H=32m 7.5kW', unit: '台', unit_price: 7800, work_hours: 0, remark: '暖通循环' },
    { category: 'equipment', name: '循环水泵', spec: 'Q=50m³/h H=35m 11kW', unit: '台', unit_price: 12000, work_hours: 0, remark: '暖通循环' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '1m³ 304不锈钢', unit: '个', unit_price: 3500, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '2m³ 304不锈钢', unit: '个', unit_price: 5800, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '3m³ 304不锈钢', unit: '个', unit_price: 7500, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '5m³ 304不锈钢', unit: '个', unit_price: 11000, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '10m³ 304不锈钢', unit: '个', unit_price: 18000, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '15m³ 304不锈钢', unit: '个', unit_price: 25000, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '不锈钢保温水箱', spec: '20m³ 304不锈钢', unit: '个', unit_price: 32000, work_hours: 0, remark: '含50mm聚氨酯保温' },
    { category: 'equipment', name: '远程控制柜', spec: '暖通专用 5.5kW以下', unit: '台', unit_price: 4500, work_hours: 0, remark: '含PLC控制器' },
    { category: 'equipment', name: '远程控制柜', spec: '暖通专用 5.5-15kW', unit: '台', unit_price: 8000, work_hours: 0, remark: '含PLC控制器+触摸屏' },
    { category: 'equipment', name: '远程控制柜', spec: '暖通专用 15-30kW', unit: '台', unit_price: 12000, work_hours: 0, remark: '含PLC控制器+触摸屏' },
    { category: 'equipment', name: '远程控制柜', spec: '暖通专用 30-55kW', unit: '台', unit_price: 18000, work_hours: 0, remark: '含PLC+触摸屏+远程通讯' },
    { category: 'equipment', name: '变频器', spec: '1.5kW', unit: '台', unit_price: 1200, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '2.2kW', unit: '台', unit_price: 1500, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '3kW', unit: '台', unit_price: 1800, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '5.5kW', unit: '台', unit_price: 2500, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '7.5kW', unit: '台', unit_price: 3200, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '11kW', unit: '台', unit_price: 4500, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '15kW', unit: '台', unit_price: 5800, work_hours: 0, remark: '' },
    { category: 'equipment', name: '变频器', spec: '22kW', unit: '台', unit_price: 7500, work_hours: 0, remark: '' },
    { category: 'equipment', name: '暖通配电箱', spec: '动力柜 30kW以下', unit: '台', unit_price: 3500, work_hours: 0, remark: '含断路器等元件' },
    { category: 'equipment', name: '暖通配电箱', spec: '动力柜 30-60kW', unit: '台', unit_price: 5500, work_hours: 0, remark: '含断路器等元件' },
    { category: 'equipment', name: '暖通配电箱', spec: '动力柜 60-100kW', unit: '台', unit_price: 8500, work_hours: 0, remark: '含断路器等元件' },
    { category: 'equipment', name: '膨胀水箱', spec: '闭式 50L', unit: '台', unit_price: 800, work_hours: 0, remark: '暖通系统用' },
    { category: 'equipment', name: '膨胀水箱', spec: '闭式 100L', unit: '台', unit_price: 1200, work_hours: 0, remark: '暖通系统用' },
    { category: 'equipment', name: '膨胀水箱', spec: '闭式 200L', unit: '台', unit_price: 1800, work_hours: 0, remark: '暖通系统用' },
